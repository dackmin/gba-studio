...
export interface EventMovePlayerToProps {
  event: MovePlayerToEvent;
  onValueChange?: (
    event: MovePlayerToEvent,
  ) => void;
}

const EventMovePlayerTo = ({
  event,
  onValueChange,
}: EventMovePlayerToProps) => {
  ...
  const sprite = useMemo(() => (
    findSprite(sprites, scene?.player?.sprite)
  ), [sprites, scene?.player?.sprite]);
...
export default EventMovePlayerTo;
